...
class CarRacing:
    ...
    def racing_window(self):
        ...
        pygame.display.set_caption('Car Race by AVP.thegreat')
        self.run_car()
    ...
    def display_credit(self):
        font = pygame.font.SysFont("lucidaconsole", 13)
        text = font.render("THANKS FOR PLAYING,", True, self.white)
        self.gameDisplay.blit(text, (600, 520))
        text = font.render("GAME BY VARDHAN", True, self.white)
        self.gameDisplay.blit(text, (600, 540))
        text = font.render("avpthegreat1903@gmail.com", True, self.white)
